import { CREATE_USER_ROUTE, USERS_GET_ROUTE, USER_DELETE_ROUTE, USER_UPDATE_ROUTE, GET_USER_ROUTE, USERS_GET_TASKS_BY_CLASSROOM, FORGOT_PASSWORD_ROUTE, RESET_PASSWORD_ROUTE, ACTIVATE_ACCOUNT_ROUTE, GET_ANSWERS_BY_USER } from "../utils/routes/vasedApiRoutes"
...
export const getAnswersByUser = async (userId) => {
    try {
        ...
        const response = await axios.get(`${GET_ANSWERS_BY_USER}/${userId}`, config);
        return response;
    }
    catch (error) {
        return error.response;
