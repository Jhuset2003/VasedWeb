...
export default function TableAttendance() {
    ...
    //         method: "GET",
    //         headers: {
    //             "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoxLCJuYW1lIjoiRW5tYW51ZWwgSm9zZSIsImVtYWlsIjoiZWpvc2UuYWNjQGdtYWlsLmNvbSIsInJvbGUiOjF9LCJpYXQiOjE2NTM1ODAzNDksImV4cCI6MTY1MzU4Mzk0OX0.rftSLI5nJ2It9knP8TA-RmxrjcwwWS705XKFGHeYqls",
    //         }
    //     });
            ...
            <div className={TableStyles.pagination}>
                ...
                >
                    <MdOutlineDoubleArrow
                        className={TableStyles.pageControllerleft}
                    />
                </button>{" "}
                <span>
                    Página&nbsp;
                ...
                >
                    <MdOutlineDoubleArrow
                        className={TableStyles.pageController}
                    />
                </button>{" "}
            </div>
        </div>
